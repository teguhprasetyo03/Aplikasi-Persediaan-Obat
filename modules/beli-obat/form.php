...
<script type="text/javascript">
  function tampil_obat(input){
    ...
    $.post("modules/beli-obat/obat.php", {
      dataidobat: num,
    }, function(response) {      
      $('#stok').html(response)
  ...
  function cek_jml_beli(input) {
    jml = document.formBeliObat.jml_beli.value;
    var jumlah = eval(jml);
    if(jumlah < 100){
      alert('Jumlah Beli Tidak Boleh Lebih dari Stok !!');
      input.value = input.value.substring(0,input.value.length-1);
    }
  }

  function hitung_jumlah_bayar() {
    bil1 = document.formBeliObat.harga_jual.value;
    bil2 = document.formBeliObat.jml_beli.value;
    ...
    document.formBeliObat.jumlah_bayar.value = (hasil);
  }
</script>
...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Input Data Pesanan Obat
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=beranda"><i class="fa fa-home"></i> Beranda </a></li>
      <li><a href="?module=beli_obat"> Beli Obat </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/beli-obat/proses.php?act=insert" method="POST" name="formBeliObat">
            <div class="box-body">
              <?php  
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" name="tanggal_beli" autocomplete="off" value="<?php echo date("d-m-Y"); ?>" required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="jml_beli" name="jml_beli" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" onkeyup="hitung_total_stok(this)&cek_jumlah_masuk(this)" required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="jumlah_bayar" name="jumlah_bayar" readonly required>
                </div>
              </div>
