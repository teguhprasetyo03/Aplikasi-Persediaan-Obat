...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_obat_keluar(kode_transaksi,tanggal_masuk,kode_obat,jumlah_keluar,created_user) 
                                            VALUES('$kode_transaksi','$tanggal_masuk','$kode_obat','$jumlah_keluar','$created_user')")
