...
if ($_SESSION['hak_akses'] == 'Super Admin') { ?>
  ...
  <ul class="sidebar-menu">
    ...
    // jika tidak, menu data obat masuk tidak aktif
      ...
      <?php
      if ($_GET["module"] == "obat_keluar") { ?>
        <li class="active">
          <a href="?module=obat_keluar"><i class="fa fa-clone"></i> obat keluar</a>
        </li>
      <?php
      }
      // jika tidak, menu ubah obat keluar tidak aktif
      else { ?>
        <li>
          <a href="?module=obat_keluar"><i class="fa fa-clone"></i> obat keluar</a>
        </li>
...
if ($_SESSION['hak_akses'] == 'Pengguna') { ?>
  ...
  <ul class="sidebar-menu">
    ...
    <li>
      <a href="?module=form_obat&form=add"><i class="fa fa-folder"></i> History Pesanan</a>
    </li>
  </ul>
  <!--sidebar menu end-->
<?php
